...
public class MessageEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.homeaway.bigdata.core.MessageEvent.Builder newBuilder() {
    return new com.homeaway.bigdata.core.MessageEvent.Builder();
  }
  
  /** Creates a new MessageEvent RecordBuilder by copying an existing Builder */
  public static com.homeaway.bigdata.core.MessageEvent.Builder newBuilder(com.homeaway.bigdata.core.MessageEvent.Builder other) {
    return new com.homeaway.bigdata.core.MessageEvent.Builder(other);
  }
  
  /** Creates a new MessageEvent RecordBuilder by copying an existing MessageEvent instance */
  public static com.homeaway.bigdata.core.MessageEvent.Builder newBuilder(com.homeaway.bigdata.core.MessageEvent other) {
    return new com.homeaway.bigdata.core.MessageEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MessageEvent>
    ...
    private Builder() {
      super(com.homeaway.bigdata.core.MessageEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.homeaway.bigdata.core.MessageEvent.Builder other) {
      super(other);
    ...
    private Builder(com.homeaway.bigdata.core.MessageEvent other) {
            super(com.homeaway.bigdata.core.MessageEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'time' field */
    public com.homeaway.bigdata.core.MessageEvent.Builder setTime(long value) {
    ...
    public com.homeaway.bigdata.core.MessageEvent.Builder clearTime() {
    ...
    /** Sets the value of the 'host' field */
    public com.homeaway.bigdata.core.MessageEvent.Builder setHost(java.lang.String value) {
    ...
    public com.homeaway.bigdata.core.MessageEvent.Builder clearHost() {
      host = null;
    ...
    /** Sets the value of the 'message' field */
    public com.homeaway.bigdata.core.MessageEvent.Builder setMessage(java.lang.String value) {
    ...
    public com.homeaway.bigdata.core.MessageEvent.Builder clearMessage() {
      message = null;
